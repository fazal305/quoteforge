...
import { catalogItemSchema, type CatalogItemFormValues } from '@/lib/schemas'
...
export function CatalogItemFormModal({ open, onClose, onSubmit, initial, submitting }: Props) {
  const {
    register,
    handleSubmit,
    reset,
    formState: { errors },
  } = useForm<CatalogItemFormValues>({ resolver: zodResolver(catalogItemSchema), defaultValues: EMPTY })
