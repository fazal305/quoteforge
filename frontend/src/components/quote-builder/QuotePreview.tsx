...
import type { BuilderState } from './useQuoteBuilder'
import type { OrganizationRow, CustomerRow } from '@/types/database'
...
export function QuotePreview({ open, onClose, state, organization, customer, quoteNumber }: Props) {
