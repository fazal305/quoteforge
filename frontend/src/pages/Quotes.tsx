...
import type { QuoteStatusDb } from '@/types/database'

const STATUS_FILTERS: Array<QuoteStatusDb | 'ALL'> = [
  'ALL', 'DRAFT', 'SENT', 'VIEWED', 'APPROVED', 'REJECTED', 'CHANGE_REQUESTED', 'EXPIRED', 'CONVERTED',
]

export function Quotes() {
  const [search, setSearch] = useState('')
  const [status, setStatus] = useState<QuoteStatusDb | 'ALL'>('ALL')
    ...
    <div>
      ...
      <div className="p-6">
        <div className="mb-4 flex flex-wrap items-center gap-3">
          ...
          <select
            value={status}
            onChange={(e) => setStatus(e.target.value as QuoteStatusDb | 'ALL')}
