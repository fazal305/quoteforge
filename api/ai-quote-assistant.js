 ...
 *
 * Shares its implementation with netlify/functions/ai-quote-assistant.js —
 * this file exists only because Vercel's function routing/runtime
 * conventions differ from Netlify's; the logic (including the required-
 * auth check) is identical. Uses Vercel's classic (req, res) Node.js
 * handler signature — the Web-standard Request/Response signature
 * silently hangs on Vercel's Node runtime.
 */
